...
public class Constants
{
    ...
    public static final String webLocalScm = "https://web.discoexample.dev.scmnight.com/";
    public static final String apiUrl = "https://api.discoexample.dev.scmnight.com/app/";
